    ...
    <div class="section-wrapper">
        <div class="section-wrapper-inner">
            ...
            <p><span class="support-faq-question"><?php esc_html_e( 'Do you need support?', 'astro-sticky-buttons' ); ?></span><br>
                <span class="support-faq-answer"><?php esc_html_e( 'Request support at the ', 'astro-sticky-buttons' ); ?> <a href="https://wordpress.org/support/plugin/astro-sticky-buttons/" target="_blank"><?php _e( 'plugin support page', 'astro-sticky-buttons' ); ?></a> <?php _e( 'or write me an email to', 'astro-sticky-buttons' ); ?> <a href="mailto:info@astrothemes.com">info@astrothemes.com</a>.</span></p>

            <hr />

            <h3 id="support-data-reset" class="title"><?php _e( 'Plugin data reset', 'astro-sticky-buttons' ); ?></h3>
            <p><a class="button button-primary" href="<?php echo $delete_options_url; ?>"><?php _e( 'Remove all plugin settings', 'astro-sticky-buttons' ); ?></a></p>
